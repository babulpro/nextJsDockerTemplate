    ...
    <div className="bg-slate-700 min-h-screen flex justify-center items-center">
      <div className="md:w-3/5 w-4/5 shadow-xl md:py-10 py-4 px-2">
        <form onSubmit={FormSubmitHandler}>
          ...
          <input type="text" value={data.title} onChange={(e) => InputChange("title", e.target.value)} className="inputClass text-left w-full" id="title" /> <br /><br />

          <label htmlFor="description">Rent description</label><br />
          <textarea value={data.description} onChange={(e) => InputChange("description", e.target.value)} className="inputClass text-left w-full" id="description" rows="3" /> <br /><br />

          <label htmlFor="city">City</label><br />
          <input type="text" value={data.city} onChange={(e) => InputChange("city", e.target.value)} className="inputClass text-left w-full" id="city" /> <br /><br />

          <label htmlFor="address">Address</label><br />
          <input type="text" value={data.address} onChange={(e) => InputChange("address", e.target.value)} className="inputClass text-left w-full" id="address" /> <br /><br />

          <label htmlFor="contactNumber">Contact Number</label><br />
          <input type="text" value={data.contactNumber} onChange={(e) => InputChange("contactNumber", e.target.value)} className="inputClass text-left w-full" id="contactNumber" /> <br /><br />

          <label htmlFor="rentPrice">Rent Price ({data.currency})</label><br />
          <input type="number" placeholder="9500" value={data.rentPrice} onChange={(e) => InputChange("rentPrice", e.target.value)} className="inputClass w-full" id="rentPrice" /> <br /><br />
          ...
          <div className="mt-8">
            <input type="submit" value="Post Rent" className="p-2 bg-slate-200 rounded hover:bg-slate-300 cursor-pointer" />
          </div>
        </form>
      </div>
    </div>
